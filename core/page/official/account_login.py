...
from core.page.main.b_home import CompanyMain
from core.page.official.forget import ForgetPassword
from core.page.official.register import Register
from core.page.official.wv_login import VxLogin
